...
\caption{Illustrative MUTAG examples. Each row shows three graphs from one source: real dataset graphs, top-ranked saved 1-GNN explanations, or top-ranked saved 1-2-GNN explanations. These examples are for visual orientation only; the quantitative claims use the full 1000-graph generated populations.}
...
\caption{Illustrative PROTEINS examples. Each row shows three graphs from one source: real dataset graphs, top-ranked saved 1-GNN explanations, or top-ranked saved 1-2-GNN explanations. The generated examples make the population-level shifts easier to see, but they are not used as standalone evidence.}
